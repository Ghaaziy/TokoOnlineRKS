                  ...
                  <form action="proses/tambahProduk.php" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="kategori" name="kategori">
                        ...
                        <option value="cernak">Cerpen Anak</option>
                      </select>
                    </div>
                    <div class="form-group">
              ...
              <ul class="nav nav-pills" style="margin-left: 15vw;">
                <li class="dropdown active item-kategori">
                  ...
                  <ul class="dropdown-menu">
                    <li><a data-toggle="tab" href="#tabel-novel">Novel</a></li>
                    <li><a data-toggle="tab" href="#tabel-cerpen">Cerpen</a></li>
                  </ul>
                </li>
                <li class="item-kategori"><a data-toggle="tab" href="#tabel-sejarah">Sejarah</a></li>
                <li class="item-kategori"><a data-toggle="tab" href="#tabel-pelajaran">Pelajaran</a></li>
                <li class="item-kategori"><a data-toggle="tab" href="#tabel-cernak">Cerpen Anak</a></li>
              </ul>
            </div>

            <div class="tab-content">
              <div id="tabel-novel" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
              ...
              <div id="tabel-cerpen" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
              ...
              <div id="tabel-sejarah" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
              ...
              <div id="tabel-pelajaran" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
              ...
              <div id="tabel-cernak" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
