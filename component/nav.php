  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:7vw; height:10vh; padding-top:0px;" alt="Brand" src="asset/img/brand2.png">
      </a>
    </div>
    ...
    <form action="pencarian.php" method="get" class="navbar-form navbar-right" style="margin-top: 4vh">
      <div class="input-group" style="width:45vw; margin-right: 8vw; margin-top: 1vh;">
        <input type="text" class="form-control" placeholder="Masukan kata kunci pencarian buku..." name="keyword">
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
      <a href="home.php"><img style="width:7vw; height:10vh; " alt="Brand" src="asset/img/brand2.png"></a>
    </div>
    <div class="col-xs-6">
